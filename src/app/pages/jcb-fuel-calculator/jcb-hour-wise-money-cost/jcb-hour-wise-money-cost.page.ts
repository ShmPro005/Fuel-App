...
@Component({
  selector: 'app-jcb-hour-wise-money-cost',
  templateUrl: './jcb-hour-wise-money-cost.page.html',
  styleUrls: ['./jcb-hour-wise-money-cost.page.scss'],
})
export class JcbHourWiseMoneyCostPage {
  hourlyRate: number = 0;
  totalHours: string = '';
  ...
  async saveRecord() {
    ...
    if (this.totalCost !== null) {
      const record: FuelCostRecord = {
        ...
        title: 'JCB_HOUR_WISE_MONEY_COST_CALCULATION',
      };
